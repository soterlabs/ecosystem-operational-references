...
1. **VaultV2**
   ...
   - Contract address: https://etherscan.io/address/0xf42bca228D9bd3e2F8EE65Fec3d21De1063882d4
   - Deployment transaction: https://etherscan.io/tx/0x9433e876a034e9a00d5fe83ff321023edbea9a82b108874feb422b5d8b096aef
   - Code verification
     - If deployed by a factory
       ...
       - **[ADDED]** Function arguments:
         ...
         2. `address asset`
            ...
            - External source / verification / confirmer: USDS token from chainlog
         3. `bytes32 salt`
...
2. **MorphoChainlinkOracleV2**
   - Chain name: Ethereum Mainnet
   - Contract address: https://etherscan.io/address/0x0A976226d113B67Bd42D672Ac9f83f92B44b454C
   - Deployment transaction: https://etherscan.io/tx/0xdccc7ebbcbbff04484b2156993cf94b9f4a2c8d6c6424bbd8efced6afa6be2bc
   - Code verification
     - If deployed by a factory
       ...
       - **[ADDED]** Function arguments:
         ...
         2. `uint256 baseVaultConversionSample`
            ...
            - External source / verification / confirmer: No conversion
         3. `AggregatorV3Interface baseFeed1`
            - Argument value: `0x0000000000000000000000000000000000000000`
            - External source / verification / confirmer: No base feed 1
         4. `AggregatorV3Interface baseFeed2`
            - Argument value: `0x0000000000000000000000000000000000000000`
            - External source / verification / confirmer: No base feed 1
         5. `uint256 baseTokenDecimals`
            - Argument value: `18`
            - External source / verification / confirmer: https://etherscan.io/address/0x99cd4ec3f88a45940936f469e4bb72a2a701eeb9#readProxyContract#F12
         6. `IERC4626 quoteVault`
            - Argument value: `0x0000000000000000000000000000000000000000`
            - External source / verification / confirmer: No quote vault
         7. `uint256 quoteVaultConversionSample`
            - Argument value: `1`
            - External source / verification / confirmer: No conversion
         8. `AggregatorV3Interface quoteFeed1`
            - Argument value: `0x0000000000000000000000000000000000000000`
            - External source / verification / confirmer: No quote feed 1
         9. `AggregatorV3Interface quoteFeed2`
            - Argument value: `0x0000000000000000000000000000000000000000`
            - External source / verification / confirmer: No quote feed 1
         10. `uint256 quoteTokenDecimals`
             - Argument value: `18`
             - External source / verification / confirmer: Same decimals as stUSDS
         11. `bytes32 salt`
             - Argument value: `0xb273084bcea4c0f298787a8fc48968cb206800e11655722046f47c47d78a8a27`
             - External source / verification / confirmer: Random value
...
3. **MorphoMarketV1AdapterV2**
   ...
   - Chain name: Ethereum Mainnet
   - Contract address: https://etherscan.io/address/0xaaf8Bf4B6E8cCb74B7f5E96D4A27fF967c1eEF74
   - Deployment transaction: https://dashboard.tenderly.co/tx/0x3514a7874e9a3f3364ba1c523597b49223611022245fe25d4f92711215a71050
   - Code verification
     - If deployed by a factory
       - Contract being called: https://etherscan.io/address/0x32BB1c0D48D8b1B3363e86eeB9A0300BAd61ccc1
       - External docs page with this address: https://docs.morpho.org/get-started/resources/addresses/#morpho-v2-contracts
...
|---|---|---|
| USDS Risk Capital | https://app.merkl.xyz/opportunities/ethereum/ERC20LOGPROCESSOR/0xf42bca228D9bd3e2F8EE65Fec3d21De1063882d4 | W1: 30k USDS, W2: 15k USDS, W3+: Integration Boost only |
| USDC Risk Capital | https://app.merkl.xyz/opportunities/ethereum/ERC20LOGPROCESSOR/0x56bfa6f53669B836D1E0Dfa5e99706b12c373ecf | W1: 30k USDS, W2: 20k USDS, W3-5: 10k USDC |
| USDT Risk Capital | https://app.merkl.xyz/opportunities/ethereum/ERC20LOGPROCESSOR/0x2bD3A43863c07B6A01581FADa0E1614ca5DF0E3d | W1: 30k USDS, W2: 20k USDS, W3-5: 10k USDT |
| USDS Flagship | https://app.merkl.xyz/opportunities/ethereum/ERC20LOGPROCESSOR/0xE15fcC81118895b67b6647BBd393182dF44E11E0 | W1: 50k USDS, W2: 50k USDS, W3-6: 25k USDS, W7-8: 20k USDS, W9+: Integration Boost only |
| USDT Savings | https://app.merkl.xyz/opportunities/ethereum/ERC20LOGPROCESSOR/0x23f5E9c35820f4baB695Ac1F19c203cC3f8e1e11 | W1: 50k USDT, W2: 50k USDT, W3-6: 25k USDT, W7-8: 20k USDT |
